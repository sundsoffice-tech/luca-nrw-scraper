/**
 * LUCA Custom Sections for GrapesJS Builder
 * Professional, ready-to-use sections for landing pages
 * Includes: Hero variants, Stats, Testimonials, Pricing, FAQ, CTA, Features, Lead Form, Countdown, Footer
 */

export default function loadLucaCustomBlocks(editor) {
